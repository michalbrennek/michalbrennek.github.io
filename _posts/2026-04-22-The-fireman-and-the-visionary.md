...
Arakawa understood this by the late 1960s. With his UCLA Atmospheric Sciences colleague Vivian R. Lamb -- his co-equal scientific collaborator on the project -- he worked out a systematic catalogue of alternatives. Their 1977 paper in the *Methods in Computational Physics* series, titled "Computational Design of the Basic Dynamical Processes of the UCLA General Circulation Model," laid out five grid configurations, labelled A through E, each with different placements of u, v, and the scalars.[^14] Lamb and Arakawa would later co-author the 1981 paper in *Monthly Weather Review* on a potential-enstrophy and energy conserving scheme for the shallow-water equations, which extended the same conservation philosophy from the 1966 Jacobian to the full primitive-equation set.
...
Charney assembled a panel of nine scientists: himself as chair, D. James Baker of the Joint Oceanographic Institutions, Bert Bolin of Stockholm, Robert Dickinson of NCAR, Richard Goody of Harvard, Cecil Leith of NCAR, Henry Stommel of Woods Hole, Carl Wunsch of MIT -- and, as the sole representative of the atmospheric-modelling community, Akio Arakawa. Syukuro Manabe and James Hansen attended as outside experts and briefed the panel on what their respective GCMs were producing. The panel met at Woods Hole from July 23 to 27, 1979.
