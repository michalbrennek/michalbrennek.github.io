...
And like any responsible adult, I accepted immediately.

## 1) The Setup: A Tiny Hackathon, a Huge Deadline, and One Rusty Compiler
...
- **Emergency:** my fellow PhD student (hi Abhishek 👋) is at serious risk of not making his defense timeline.
...
## 2) GeoTOP Architecture Review (Spoiler: It’s a Dungeon)

You know how some legacy codes feel like a well-loved workshop?  
GeoTOP feels like a **castle built out of spaghetti**, with load-bearing comments like:

- `// TODO: fix this someday`
- `// works`
- `// do not touch`

The architecture is… how do I put this politely…
...
## 3) First Attempt: “I See Obvious OpenMP Candidates!”

I did what every HPC goblin does on sighting a loop:
...
## 4) Summoning Reinforcements: Claude Agents Enter the Party

At this point, I did the only reasonable thing:
...
This was a **support raid**: get a proof-of-concept, get Abhishek unblocked, and see if there’s a path to “this model finishes before the heat death of the universe.”
...
## 5) Achievement Unlocked: It Compiled! (Plot Twist: It Got Worse)

We did some light architecture work, carefully avoided rewriting the model, and…
...
And it was **13 hours longer** than the original model.
...
## 6) Naming Ceremony: Welcome to *GeoBOTTOM*
...
## 7) “You Don’t Forget C++ — It’s Like Riding a Bike!”

I refused to believe the universe. I refused to believe *me*.  
I had been “fermenting code in Python” for so long that my brain thought semicolons were optional lifestyle choices.
...
- **Meaningful improvement:** about **half an hour faster** than the original.
...
## 8) “Now It Uses All Cores!” (At 3% Utilization 🙃)
...
## 9) The Realization: Parallelization Isn’t a Spell, It’s a Contract
...
### 🔥 Recomputing constants… constantly.

The original authors were calculating the same “constants” every timestep like they were afraid slopes might evolve overnight.
...
## 10) The Big Win: Precompute Everything + RAM Is My Brim
...
### Cut I/O like it owes you money.

I have **~1 TB of RAM** sitting there, quietly judging me.
...
That’s not a speedup. That’s an exorcism.

> **2 humans, 1 synthetic intellect, and 1 TB of RAM walk into a bar…**  
> The bartender says, “Oh, you’re here to remove I/O bottlenecks.”

## 11) The Final Boss: The Timer That Lies

GeoTOP has a “nice” progress timer that tells you how many hours remain.
...
So I did the most scientific thing possible:
...
That’s performance engineering, baby.

## 12) Where We Are Now (and Where This Is Going)
...
- Abhishek’s defense timeline: less doomed than yesterday.  
- My C++ confidence: still in recovery, but no longer clinically deceased.

Next up: more precomputation, more I/O discipline, and possibly teaching GeoTOP that “constant” means *constant*.
