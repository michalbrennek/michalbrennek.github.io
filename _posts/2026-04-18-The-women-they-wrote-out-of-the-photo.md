---
layout: single
title: "The Women They Wrote Out of the Photo"
date: 2026-04-18 08:00:00 +0100
categories: [Weather, HPC, History]
tags: [Women, ENIAC, KlaravonNeumann, AdeleGoldstine, BettyHolberton, MaryTsingou, MargaretHamilton, Computing]
header:
  teaser: /assets/images/header-women-computing.jpg
  overlay_image: /assets/images/header-women-computing.jpg
  overlay_filter: "0.6"
excerpt: "In 1946, the U.S. Army released photographs of the ENIAC with men in suits identified by name. The women who had programmed the machine were in the pictures but unnamed in the captions. For fifty years, nobody asked who they were."
---
...
They had learned to program the machine by studying wiring diagrams -- because [Adele Goldstine](#the-woman-who-trained-them-all) had not yet finished writing the manual.
...
## The Woman Who Trained Them All
...
At Los Alamos, she became one of the first programmers on [MANIAC](/weather/hpc/history/2026/04/08/The-blueprint-von-Neumann-gave-away.html), the computer that von Neumann and Bigelow had built. Along with Mary Hunt, she was among the first to start exploratory work on the machine. With John Pasta, she created the **first computer graphics on MANIAC** -- making her a pioneer of computer graphics.
...
## From Weather to the Moon

![Margaret Hamilton standing next to a stack of Apollo guidance software printouts, 1969. She coined the term "software engineering." Before Apollo, she programmed Edward Lorenz's weather simulations on the LGP-30 at MIT. NASA, public domain.](/assets/images/Margaret_Hamilton.jpg)
...
I wrote about Lorenz and the butterfly effect in [Post 8](/weather/hpc/history/2026/03/31/The-butterfly-that-broke-the-forecast.html). I mentioned that Lorenz's simulations ran on a Royal McBee LGP-30. I did not mention who programmed that LGP-30. It was Margaret Hamilton. She was 22 when she started.

---

## Maybe We Should Have Called It Arianna
...
In 1951, she married physicist Marshall Rosenbluth. At Los Alamos, she learned to program [MANIAC I](/weather/hpc/history/2026/04/08/The-blueprint-von-Neumann-gave-away.html) when she verified calculations for the first full-scale test of a hydrogen bomb in 1952.
...
## The Women Whose Names Are Not Recorded
...
I have been telling you the story of computing, weather prediction, and the machines that changed how we understand the world. This is Post 19 in the series. In every previous post, the names I gave you were men's names: [Richardson](/weather/hpc/history/2026/03/24/The-man-who-forecasted-weather-with-a-pencil.html), [Smagorinsky](/weather/hpc/history/2026/03/25/The-number-that-connects-turbulence-to-war.html), [Charney](/weather/hpc/history/2026/03/29/The-man-who-tamed-the-equations.html), [Lorenz](/weather/hpc/history/2026/03/31/The-butterfly-that-broke-the-forecast.html), [von Neumann](/weather/hpc/history/2026/04/08/The-blueprint-von-Neumann-gave-away.html), [Beurling](/weather/hpc/history/2026/04/04/The-magician-who-told-no-secrets.html). Those men did extraordinary things. Their achievements are real. But the story I told was incomplete -- because the story that was told to me was incomplete. The women were there. They were always there. They were in the photographs. They were just not named in the captions.
...
* Dauxois, T. (2008). "Fermi, Pasta, Ulam, and a Mysterious Lady." *Physics Today*, 61(1), 55-57. [arXiv](https://arxiv.org/abs/0801.1590)
* Gelman, A. (2021). "Maybe we should've called it Arianna." *Statistical Modeling, Causal Inference, and Social Policy.* [Blog](https://statmodeling.stat.columbia.edu/2021/02/09/maybe-we-shouldve-called-it-arianna/)
* APS (2022). "Arianna Rosenbluth and the Metropolis Monte Carlo Algorithm." *APS News.* [APS](https://www.aps.org/apsnews/2022/03/rosenbluth-metropolis-monte-carlo-algorithm)
* IMS (2021). "Obituary: Arianna Rosenbluth 1927-2020." *Institute of Mathematical Statistics.* [IMS](https://imstat.org/2021/02/23/obituary-arianna-rosenbluth-1927-2020/)
* Radcliffe Institute at Harvard. "Flash of Genius." [Radcliffe](https://www.radcliffe.harvard.edu/news-and-ideas/flash-of-genius)
* Witman, S. (2017; updated 2021). "Meet the Computer Scientist You Should Thank for Your Smartphone's Weather App." *Smithsonian Magazine.* [Smithsonian](https://www.smithsonianmag.com/science-nature/meet-computer-scientist-you-should-thank-your-phone-weather-app-180963716/)
* Hafner, K. (2022). *Lost Women of Science* podcast, Season 2: "A Grasshopper in Very Tall Grass." [Lost Women of Science](https://www.lostwomenofscience.org/klara-dan-von-neumann)
* Haigh, T. "Klara von Neumann, a 'Lost Woman of Science'." [Tom and Maria](https://www.tomandmaria.com/Tom/node/30)
* Hamilton, M. "Margaret Hamilton (software engineer)." *Wikipedia.* [Wikipedia](https://en.wikipedia.org/wiki/Margaret_Hamilton_(software_engineer))
* *Quanta Magazine* (2019). "The Hidden Heroines of Chaos." [Quanta](https://www.quantamagazine.org/the-hidden-heroines-of-chaos-20190520/)
* MIT News (2016). "Apollo code developer Margaret Hamilton receives Presidential Medal of Freedom." [MIT](https://news.mit.edu/2016/apollo-code-developer-margaret-hamilton-receives-presidential-medal-of-freedom-1117)
* Tsingou, M. biography. *MacTutor History of Mathematics.* [MacTutor](https://mathshistory.st-andrews.ac.uk/Biographies/Tsingou/)
* *National Security Science* (2020). "We Thank Miss Mary Tsingou." Los Alamos National Laboratory.
* *Science News* (2019). "Core memory weavers and Navajo women made the Apollo missions possible." [Science News](https://www.sciencenews.org/article/core-memory-weavers-navajo-apollo-raytheon-computer-nasa)
* Kleiman, K. ENIAC Programmers Project. [eniacprogrammers.org](https://eniacprogrammers.org/)
* Fritz, W.B. "The Women of ENIAC." *IEEE Annals of the History of Computing.* [IEEE/PDF](https://courses.cs.washington.edu/courses/csep590a/06au/readings/00511940-frist.pdf)
* Library of Congress. "John Von Neumann and Klara Dan Von Neumann papers." [LOC](https://www.loc.gov/item/mm82044180/)
