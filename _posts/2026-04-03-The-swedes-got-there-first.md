...
A full disclosure before we begin. Sweden holds a special place in my heart. There is no better way to spend a weekend — except maybe messing around in boats — than to build a good adult LEGO set from IKEA, with a break for a portion of köttbullar (my kids' absolute favourite) with lingonberry jam. There is nothing you cannot accomplish after a proper portion of köttbullar. Debug a climate model? Build a computer from vacuum tubes? Beat the Americans to operational weather forecasting? Just add lingonberry jam and anything becomes possible. And if the Swedish Chef from the Muppets has taught us anything, it's that you can accomplish great things in a kitchen — or a computer room — while being completely incomprehensible to everyone around you. "Bork bork bork!" as the man said, right before something exploded.
