...
header:
  ...
  overlay_filter: "0.6"
excerpt: "In 2026, a language designed in 1954 for an eight-ton vacuum-tube machine still runs every operational weather forecast, every major climate model, and -- through a chain that most Python programmers have never traced -- every matrix-inverse call you make from NumPy. This post is about how that happened, and why nobody can stop it."
---
