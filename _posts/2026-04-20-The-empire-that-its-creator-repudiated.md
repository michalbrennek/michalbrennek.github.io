...
By 1966, a single source at IBM estimates that FORTRAN compilers were generating somewhere around three hundred million dollars of IBM revenue annually. That is close to three billion 2025 dollars. The compiler that Backus had sold to Cuthbert Hurd in December 1953 for a small research budget had become, in twelve years, the profit centre on which IBM's scientific-computing business rested. Backus himself had been named an **IBM Fellow** in 1963, at the age of thirty-eight. An IBM Fellowship came with a budget and absolute research autonomy. For the next twenty-eight years, Backus used it to work on languages other than FORTRAN. His repudiation of FORTRAN, when it came, was being funded by FORTRAN sales.[^12]
